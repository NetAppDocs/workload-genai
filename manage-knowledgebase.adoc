...
. In the Edit knowledge base page, you can change the knowledge base name, description, embedding model, chat model, and whether conversation starters are created automatically or manually.
+
