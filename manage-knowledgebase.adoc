...
Snapshots can be faster and more efficient than backups, and enable you to protect each knowledge base using a different protection policy. Some of the scenarios where snapshots can be useful are:

* Recovering from incorrect data being ingested into the knowledge base
* Helping with testing different data sources, and reverting when the testing is complete
