...
| Apache Parquetfootnote:disclaimer[The data guardrails feature is not supported when ingesting structured data files.] | .parquet
| Comma-separated values filefootnote:disclaimer[] | .csv
| Graphics Interchange Format | .gif 
| JPEG | .jpg or.jpeg
| JSON and JSONPfootnote:disclaimer[] | .json
| Markdown | .md
