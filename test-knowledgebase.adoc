...
. In the chatbot entry field, enter a prompt or question and click the image:button-run.png[run button] to see how your chatbot responds with your organizational knowledge.
