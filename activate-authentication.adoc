...
* Algorithms 
+
Choose the algorithm that your provider uses.
* Audience (Optional)
+
The intended recipient of the authentication token.
* Issuer
+
A string that identifies the provider that issued the token. For example, Amazon Cognito uses issuer strings that follow the following format:
+
----
