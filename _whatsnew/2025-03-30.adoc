...
Using the workload factory API, you can now add a data source from a generic NFSv3, NFSv4, or SMB share. The workload factory web UI will support these abilities in a future release.
