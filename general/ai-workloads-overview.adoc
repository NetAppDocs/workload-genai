...
summary: NetApp Workload Factory for GenAI enables you to integrate Amazon FSx for NetApp ONTAP file systems with GenAI foundation models. This provides you with high performance storage with a rich set of protection, security, and cost optimization features for your AI datasets.
---
...
NetApp Workload Factory for GenAI simplifies the process to deploy infrastructure needed to build Generative AI applications using retrieval-augmented generation (RAG). Specifically, GenAI provides the following benefits: 
...
== How NetApp Workload Factory for GenAI helps to build Generative AI applications
...
== Regions
Workload Factory is supported in all commercial regions where FSx for ONTAP is supported. link:https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/[View supported Amazon regions.^]
