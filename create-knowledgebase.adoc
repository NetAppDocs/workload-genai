...
.. *Snapshot policy*: Choose a snapshot policy from the list of existing policies defined in the Workload Factory storage inventory. You can also add or modify snapshot policies if none exist.
