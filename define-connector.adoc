...
summary: After you've deployed the AI infrastructure and identified the data sources that you'll integrate in your connector configuration, you can define a connector.
---

= Define an external AI assistant connector
:icons: font
:imagesdir: ./media/

[.lead]
After you've deployed the AI infrastructure and identified the data sources that you'll use with the connector from your FSx for ONTAP datastores, you are ready to define the connectore using workload factory. 

.About this task
Connectors have two data integration modalities - _public mode_ and _Enterprise mode_. 
...
. From the Knowledge bases tab, select the *Create New* dropdown and choose *NetApp GenAI knowledge base for Bedrock*.
...
.. *Chat model*: Choose from Anthropic Claude or Amazon Nova chat models that are integrated in Amazon Bedrock. Note that you must have already enabled the chat model from Amazon Bedrock.
+
...
You can add one or more data sources to populate the external AI assistant index with your organization's data.
