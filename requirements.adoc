...
Chat model::
You must enable the foundational chat model that you plan to use before creating your knowledge base. GenAI supports the following Anthropic Claude and Amazon Nova models:
+
* Anthropic Claude:
** Claude 3.5 Sonnet
** Claude 3 Opus
...
Learn more about using Anthropic's Claude: https://aws.amazon.com/bedrock/claude/[Anthropic's Claude in Amazon Bedrock^]
Learn more about using Amazon Nova: https://docs.aws.amazon.com/nova/latest/userguide/getting-started-console.html[Getting started with Amazon Nova in the Amazon Bedrock console^]
