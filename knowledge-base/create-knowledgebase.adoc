...
* If applicable, choose an inference profile from the *Inference type* list to configure how responsive the chatbot is to to interactive queries versus batch requests.
...
.. *Retrieve settings*:
+
* Set a *Reranking score* to
* Choose the number of *Retrieved database documents*
* Choose the number of *Retrieved total documents*
* Choose the *Distance*
* Select a *Retrieve type*
