...
[.lead]
Ensure that workload factory and AWS are set up properly before you create a connector for Amazon Q Business. 
...
== Requirements for Amazon Q Business connectors
