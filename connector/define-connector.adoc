...
= Create a connector for Amazon Q Business
:icons: font
:imagesdir: ../media/

[.lead]
After you've deployed the AI infrastructure and identified the data sources that you'll use from your FSx for ONTAP datastores, you are ready to define an Amazon Q Business connector.
