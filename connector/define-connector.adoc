...
= Create a NetApp ONTAP Connector for Amazon Q
:icons: font
:imagesdir: ../media/

[.lead]
After you've deployed the AI infrastructure and identified the data sources that you'll use from your FSx for ONTAP datastores, you are ready to define a NetApp ONTAP Connector for Amazon Q.
...
== Define a connector
Create a NetApp ONTAP Connector for Amazon Q. The connector enables API and data source communication between GenAI and Amazon Q Business.
