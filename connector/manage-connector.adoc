...
. From the Knowledge bases & Connectors inventory page, select the connector that you want to view.
...
. From the Knowledge bases & Connectors menu, select the connector that you want to synchronize.
